...
def llama_get_prompt(instruction, new_system_prompt ):
...
# prompt_template=llama_get_prompt(instruction,system_prompt)
# print(prompt_template)
...
##################################################################
def zephyr_get_prompt(system_prompt,instruction):
     f"""<|system|>
{system_prompt}</s>
<|user|>
{instruction}</s>
<|assistant|>
"""
zephyr_prompt_template=zephyr_get_prompt(instruction,system_prompt)
print(zephyr_prompt_template)
